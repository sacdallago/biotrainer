...
class SequenceSolver:
    ...
    def train(self, training_dataloader, validation_dataloader):
        ...
        for epoch in range(self.number_of_epochs):
            ...
            epoch_metrics = {
                'training': SequenceSolver._aggregate_iteration_results(train_iterations),
                'validation': SequenceSolver._aggregate_iteration_results(validation_iterations),
                'epoch': epoch
            }
    ...
    def inference(self, dataloader):
        ...
        return {
            'metrics': SequenceSolver._aggregate_iteration_results(predict_iterations),
